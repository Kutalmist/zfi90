		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MusteriKrediLimitiIzleme",
									"targetURL": "#MusteriKrediLimitiIzleme-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MusteriKrediLimitiIzleme-display": {
								"semanticObject": "MusteriKrediLimitiIzleme",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sadal.zfi90",
									"url": sap.ui.require.toUrl("com/sadal/zfi90")
								}
							}
						}
					}
